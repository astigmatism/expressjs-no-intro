(function() {
    ...
    var _boxType = window.application.boxType;
    ...
    var ImagePreview = function(cell, formatterParams, onRendered) {
        ...
        return '<a href="/dev/boxes/media/' + _boxType + '/' + _system + '/' + file + '" target="_blank"><img src="/dev/boxes/media/' + _boxType + '/' + _system + '/' + file + '" height="100px" /></a>';
    };
